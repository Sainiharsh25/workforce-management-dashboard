...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("https://workforce-backend-syjg.onrender.com/api/auth/login", {
        method: "POST",
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch("https://workforce-backend-syjg.onrender.com/api/auth/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
